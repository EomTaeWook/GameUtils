...
namespace GameUtils.Map
{
    public class ProceduralMapGeneration : IMapGenerator
    {
        ...
        private readonly AStartPathGenerator _allPathGenerator;
        ...
        public ProceduralMapGeneration(RandomGenerator randomGenerator, int width, int height, int minRoomSize)
        {
            ...
            _allPathGenerator = new AStartPathGenerator(width, height);
        ...
        private Tuple<RoomContainer, RoomContainer> GetRandomSplitContainer(RoomContainer roomContainer)
        {
            ...
            return Tuple.Create<RoomContainer, RoomContainer>(roomContainer1, roomContainer2);
        }
        ...
        public int[,] Generate()
        {
            ...
            MakePath(rootNode, map, new IPathGenerator[] { new AStartPathGenerator(map), _allPathGenerator});
